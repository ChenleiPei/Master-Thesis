...
if __name__ == "__main__":
    ...
    parser.add_argument('--npz_file', type=str, help='Path to the .npz file containing latent vectors and original expressions', default='LSTMVAE_bin/2024-Nov-27-17-50-32/latent_vectors_and_expressions.npz')
